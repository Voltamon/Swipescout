...
const StyledAppBar = styled(AppBar)(({ theme }) => ({
  background: 'rgba(59, 130, 246, 0.5)', // Match hero section
...
const Logo = styled(Typography)(({ theme }) => ({
  ...
  '& span': {
    color: '#dbeafe', // Lighter shade for visual interest
  },
}));
    ...
    <StyledAppBar position="sticky">
      <StyledToolbar>
        ...
        <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 2 }}>
          ...
          <NavButton component={Link} to="/candidates">Candidates</NavButton>
        </Box>
