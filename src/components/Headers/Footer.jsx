  ...
  return (
    <StyledFooter>
      <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 3 }}>
        <FooterLink href="/about" underline="hover">About Us</FooterLink>
        <FooterLink href="#" underline="hover">Customer Support</FooterLink>
        <FooterLink href="#" underline="hover">Contact</FooterLink>
        <FooterLink href="/how-it-works" underline="hover">How SwipeScout Works</FooterLink>
        <FooterLink href="/FAQs" underline="hover">FAQ</FooterLink>
        <FooterLink href="#" underline="hover">Credits</FooterLink>
