  ...
  const drawerContent = (
    ...
    >
      ...
      <List sx={{ width: "100%" }}>
        {[
          {
            icon: <Home fontSize={isMobile ? "small" : "medium"} />,
            value: "home"
          },
          {
            icon: <Search fontSize={isMobile ? "small" : "medium"} />,
            value: "search"
          },
          {
          ...
          {
            icon: <Bookmark fontSize={isMobile ? "small" : "medium"} />,
            value: "saved"
          },
          {
      ...
      >
        <IconButton
          sx={{ color: theme.palette.text.primary, p: isMobile ? 0.5 : 1 }}
        >
