...
const QuickTipsAdminPage = () => {
  ...
  return (
    <div>
      <h2 className="text-lg font-bold mb-4">Quick Tips Admin</h2>
      <form onSubmit={handleSubmit} className="space-y-2 mb-4">
        ...
        <input value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} placeholder="Category" className="w-full p-2 border" />
        ...
        <div className="flex gap-2">
          ...
          {editingId && (
            <button type="button" onClick={handleCancelEdit} className="px-3 py-1 bg-gray-300 rounded">Cancel</button>
          )}
        </div>
      </form>
