...
const MarketingVideos = () => {
  ...
  return <Box sx={{ display: "flex", flexDirection: "column",
     //backgroundclr
        padding: theme.spacing(4), minHeight: "100vh", width: "100%" } // Ensure the main Box takes full width
      }>
      <Typography variant="h3" align="center" sx={{ mt: 4, mb: 6, fontWeight: "bold", color: "rgba(172, 214, 238, 0.9)", textShadow: "1px 1px 2px rgba(0,0,0,0.1)" }}>
        Marketing Videos
      </Typography>

      {/* Use Container to constrain content width on larger screens and center it */}
      <Container maxWidth="lg">
        {" "}{/* Set maxWidth to lg or xl as needed. "lg" is 1200px, "xl" is 1536px */}
