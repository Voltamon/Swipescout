...
const CardNav = () => {
    ...
    return (
        <>
            ...
            <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 w-fit max-w-[95vw] flex justify-center">
                <div
                    ...
                    <div className="flex items-center gap-1 md:gap-2">
                        {navItems.map((item) => (
                            ...
                            >
                                ...
                                />
                                <span className={`relative z-10 text-sm font-medium transition-colors duration-200 hidden md:block ${activeTab === item.id ? 'text-white' : 'text-gray-400 group-hover:text-gray-200'
                                    }`}>
                                    {item.label}
                                </span>
                            </button>
