...
const StaggeredMenu = ({
    ...
    // Effect to trigger animations based on isOpen prop
    React.useEffect(() => {
        if (isOpen) {
            playOpen();
        } else {
    ...
    // Handle Item Click for SPA Navigation
    ...
    }, [closeOnClickAway, isOpen, onMenuClose]);
    ...
    return (
        ...
        >
            ...
            {/* Header Removed - Controlled externally */}
