...
const EmployerDashboard = () => {
  ...
  // بيانات مخطط المتقدمين
  const applicantsChartData = {
    labels: stats?.job_titles || ['مطور واجهة أمامية', 'مطور خلفية', 'مصمم UI/UX', 'مدير مشروع', 'مسوق رقمي'],
    datasets: [
      {
        label: 'عدد المتقدمين',
  ...
  // بيانات مخطط مصادر المتقدمين
  const applicantSourcesChartData = {
    labels: ['البحث المباشر', 'الإحالات', 'وسائل التواصل الاجتماعي', 'مواقع التوظيف', 'أخرى'],
    datasets: [
      {
  ...
  return (
    <DashboardContainer maxWidth="lg">
      <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Typography variant="h4">لوحة تحكم صاحب العمل</Typography>
            ...
            <TabPanel value={tabValue} index={1}>
              ...
              <TableContainer>
                <Table>
                  <TableHead>
                    <TableRow>
                      <TableCell>عنوان الوظيفة</TableCell>
                      <TableCell>تاريخ النشر</TableCell>
                      <TableCell>المشاهدات</TableCell>
                      <TableCell>المتقدمين</TableCell>
                  ...
                  <TableBody>
                    {jobs.map((job) => (
                      <TableRow key={job.id}>
                        ...
                        <TableCell>
                          <Chip 
                            label={job.status === 'active' ? 'نشطة' : 'مغلقة'} 
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>نسبة التطابق</TableCell>
                      <TableCell>الحالة</TableCell>
                      <TableCell>الإجراءات</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {recommendations.slice(0, 5).map((candidate) => (
                      <TableRow key={candidate.id}>
                        ...
                        <TableCell>{new Date(candidate.applied_at).toLocaleDateString('ar-EG')}</TableCell>
                        <TableCell>
                          <Chip 
                        ...
                        <TableCell>
                          <Chip 
                            label={
                              ...
                              candidate.status === 'reviewed' ? 'تمت المراجعة' : 
                              candidate.status === 'interview' ? 'مقابلة' : 'مرفوض'
                            } 
                            color={
              ...
              {recommendations.length === 0 ? (
                <ListItem>
                  <ListItemText 
                    ...
                    secondary="ستظهر التوصيات هنا بناءً على وظائفك المنشورة" 
                  />
                </ListItem>
              ) : (
                          ...
                          <React.Fragment>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', mt: 0.5 }}>
                              ...
                              <Typography variant="body2" component="span" color="textSecondary">
                                {candidate.experience} سنوات خبرة
                              </Typography>
                            </Box>
                          </React.Fragment>
                        }
      ...
      <Paper sx={{ p: 3, mt: 3 }}>
        <Typography variant="h6" gutterBottom>
          نصائح لجذب المزيد من المرشحين المؤهلين
        </Typography>
            ...
            <Card>
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary">
                  الوظائف التي تحتوي على فيديو تحصل على نسبة تقديم أعلى بـ 34% من الوظائف التقليدية.
                </Typography>
                <Button 
                  variant="outlined" 
                  color="primary" 
          ...
          <Grid item xs={12} sm={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary">
                  الشركات ذات الملفات المكتملة تجذب مرشحين أكثر جودة وتزيد من معدل القبول.
                </Typography>
                <Button 
                  variant="outlined" 
                  color="primary" 
          ...
          <Grid item xs={12} sm={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2" color="textSecondary">
                  راجع تحليلات أداء وظائفك لتحسين معدلات الظهور والتقديم في الإعلانات المستقبلية.
                </Typography>
                <Button 
                  variant="outlined" 
                  color="primary" 
