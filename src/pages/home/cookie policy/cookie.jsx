      ...
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 sm:max-w-2xl md:max-w-3xl lg:max-w-4xl">
        <DialogHeader className={`px-4 sm:px-6 pt-6 pb-4 ${homeThemeColors.borders.default} border-b sticky top-0 ${homeThemeColors.backgrounds.dialog} z-10`}>
          <DialogTitle className={`text-xl sm:text-2xl md:text-3xl font-bold ${homeThemeColors.text.gradient} flex items-center gap-2 sm:gap-3`}>
            ...
            <span>{i18n.t('auto_cookie_policy')}</span>
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="px-4 sm:px-6 pb-6 space-y-4 sm:space-y-6">
            ...
            <div className={`flex flex-wrap gap-2 sm:gap-3 p-3 sm:p-4 bg-gradient-to-r ${homeThemeColors.gradients.card} rounded-lg border ${homeThemeColors.borders.primary}`}>
              <Badge variant="outline" className={`flex items-center gap-1.5 sm:gap-2 py-1.5 sm:py-2 px-2 sm:px-3 text-xs sm:text-sm ${homeThemeColors.components.badge.outline}`}>
                ...
                <span><strong>Effective:</strong>{i18n.t('auto_19_august_2025')}</span>
              </Badge>
              <Badge variant="outline" className={`flex items-center gap-1.5 sm:gap-2 py-1.5 sm:py-2 px-2 sm:px-3 text-xs sm:text-sm ${homeThemeColors.components.badge.outline}`}>
                <Building2 className="h-3 w-3 sm:h-4 sm:w-4" />
                <span><strong>Company:</strong>{i18n.t('auto_swipescout_ltd_uk')}</span>
              </Badge>
            </div>
            ...
            <section className={`${homeThemeColors.backgrounds.card} p-4 sm:p-6 rounded-lg ${homeThemeColors.borders.default} border ${homeThemeColors.shadows.sm}`}>
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className={`${homeThemeColors.components.section.heading} text-base sm:text-lg`}>{i18n.t('auto_1_what_are_cookies')}</h3>
              </div>
            ...
            <section className={`${homeThemeColors.backgrounds.card} p-4 sm:p-6 rounded-lg ${homeThemeColors.borders.default} border ${homeThemeColors.shadows.sm}`}>
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className={`${homeThemeColors.components.section.heading} text-base sm:text-lg`}>{i18n.t('auto_2_how_we_use_cookies')}</h3>
              </div>
              ...
              <ul className={`space-y-2 ${homeThemeColors.text.secondary} text-sm sm:text-base`}>
                <li className="flex items-start gap-2">
                  ...
                  <span><strong className={homeThemeColors.text.primary}>{i18n.t('auto_essential_cookies')}</strong>{i18n.t('auto_keep_you_logged_in_enable_swipe_and_vide')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className={`${homeThemeColors.icons.primary} mt-1`}>•</span>
                  <span><strong className={homeThemeColors.text.primary}>{i18n.t('auto_performance_cookies')}</strong> – understand how users interact with the app (analytics, crash reports).</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className={`${homeThemeColors.icons.primary} mt-1`}>•</span>
                  <span><strong className={homeThemeColors.text.primary}>{i18n.t('auto_functionality_cookies')}</strong>{i18n.t('auto_remember_preferences_and_settings')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className={`${homeThemeColors.icons.primary} mt-1`}>•</span>
                  <span><strong className={homeThemeColors.text.primary}>{i18n.t('auto_advertising_cookies_future_use')}</strong>{i18n.t('auto_show_relevant_jobs_or_promotions_only_if')}</span>
                </li>
              </ul>
            </section>
            ...
            <section className={`${homeThemeColors.backgrounds.card} p-4 sm:p-6 rounded-lg ${homeThemeColors.borders.default} border ${homeThemeColors.shadows.sm}`}>
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className={`${homeThemeColors.components.section.heading} text-base sm:text-lg`}>{i18n.t('auto_3_third_party_cookies')}</h3>
              </div>
              <p className={`${homeThemeColors.components.section.text} text-sm sm:text-base`}>
            ...
            <section className={`${homeThemeColors.backgrounds.card} p-4 sm:p-6 rounded-lg ${homeThemeColors.borders.default} border ${homeThemeColors.shadows.sm}`}>
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className={`${homeThemeColors.components.section.heading} text-base sm:text-lg`}>{i18n.t('auto_4_managing_cookies')}</h3>
              </div>
              <ul className={`space-y-2 ${homeThemeColors.text.secondary} text-sm sm:text-base`}>
                <li className="flex items-start gap-2">
                  <span className={`${homeThemeColors.icons.primary} mt-1`}>•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className={`${homeThemeColors.icons.primary} mt-1`}>•</span>
                  <span><strong className={homeThemeColors.text.primary}>On mobile app:</strong>{i18n.t('auto_you_can_manage_permissions_in_device_set')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className={`${homeThemeColors.icons.primary} mt-1`}>•</span>
            ...
            <section className={`${homeThemeColors.backgrounds.card} p-4 sm:p-6 rounded-lg ${homeThemeColors.borders.default} border ${homeThemeColors.shadows.sm}`}>
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className={`${homeThemeColors.components.section.heading} text-base sm:text-lg`}>{i18n.t('auto_5_consent')}</h3>
              </div>
              <ul className={`space-y-2 ${homeThemeColors.text.secondary} text-sm sm:text-base`}>
                <li className="flex items-start gap-2">
                  <span className={`${homeThemeColors.icons.primary} mt-1`}>•</span>
            ...
            <section className={`${homeThemeColors.backgrounds.card} p-4 sm:p-6 rounded-lg ${homeThemeColors.borders.default} border ${homeThemeColors.shadows.sm}`}>
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className={`${homeThemeColors.components.section.heading} text-base sm:text-lg`}>{i18n.t('auto_6_updates')}</h3>
              </div>
              <p className={`${homeThemeColors.components.section.text} text-sm sm:text-base`}>
            ...
            <section className={`bg-gradient-to-r ${homeThemeColors.gradients.card} p-4 sm:p-6 rounded-lg border ${homeThemeColors.borders.primary} ${homeThemeColors.shadows.md}`}>
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className={`${homeThemeColors.components.section.heading} text-base sm:text-lg`}>{i18n.t('auto_7_contact_us')}</h3>
              </div>
              <p className={`${homeThemeColors.components.section.text} mb-3 text-sm sm:text-base`}>
